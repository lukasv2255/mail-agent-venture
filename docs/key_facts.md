...
- Aktuální start příkaz: `worker: python main.py`
- Restart policy: nastavit v Railway dashboardu na `Always`
- Restart policy řeší pád procesu, ne zaseknutý živý proces
- Krátkodobé řešení zaseknutí: timeouty kolem IMAP/Gmail/OpenAI/Telegram/scrapingu
- Dlouhodobé řešení: heartbeat + `/api/health` endpoint pro Railway healthcheck
...
- **GitHub repo:** `https://github.com/lukasv2255/mail-agent-venture`
