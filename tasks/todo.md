...
## 2026-04-22 — Railway odolnost proti pádu a zaseknutí

### Plán

- [x] Zapsat do dokumentace rozdíl mezi pádem procesu a zaseknutím běžícího procesu
- [x] Zvolit krátkodobé řešení pro produkci na Railway
- [x] Popsat budoucí robustnější variantu s heartbeat healthcheckem

### Výsledky

Doplněno do `CLAUDE.md`, `AGENTS.md`, `docs/key_facts.md` a `docs/decisions.md`.
Krátkodobě platí: Railway worker přes `Procfile` (`worker: python main.py`),
Restart Policy `Always`, jedna běžící instance a timeouty kolem externích služeb.
