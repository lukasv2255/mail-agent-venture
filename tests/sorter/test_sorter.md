# Sorter — E-shop s doplňky stravy

**Odesílatel:** účet přihlášený přes Gmail API
**Příjemce / inbox agenta:** hodnota `TEST_TARGET_EMAIL` nebo `GMAIL_ADDRESS` v `.env`
**Rychlý batch skript:** `tests/sorter/test_sorter.py`
**Týdenní test:** `tests/sorter/run_week.py`
...
python3 tests/sorter/run_week.py

# Rychlý test — 20 emailů za 30 minut
python3 tests/sorter/run_week.py --fast

# Report z existujících logů
python3 tests/sorter/run_week.py --report
```
